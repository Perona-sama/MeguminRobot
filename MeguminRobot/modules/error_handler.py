...
from MeguminRobot import dispatcher, DEV_USERS, OWNER_ID

pretty_errors.mono()


class ErrorsDict(dict):
    "Diktik khusus untuk menyimpan kesalahan dan jumlahnya"
...
def error_callback(update: Update, context: CallbackContext):
    ...
    try:
        ...
        pretty_error = "Gagal membuat kesalahan cantik."    
    ...
    pretty_message = (
        "{}\n"
        "-------------------------------------------------------------------------------\n"
        "Pengecualian muncul saat menangani update\n"
        "User: {}\n"
        "Chat: {} {}\n"
        "Callback data: {}\n"
        "Message: {}\n\n"
