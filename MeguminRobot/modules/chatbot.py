...
import MeguminRobot.modules.sql.chatbot_sql as sql
from coffeehouse.api import API
from coffeehouse.exception import CoffeeHouseError as CFError
from coffeehouse.lydia import LydiaAI
from MeguminRobot import AI_API_KEY, OWNER_ID, SUPPORT_CHAT, dispatcher
...
def add_chat(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        msg.reply_text("Anda tidak dapat mengaktifkan AI di PM.")
        return
...
__help__ = f"""
Chatbot menggunakan API CoffeeHouse dan memungkinkan Megumin untuk berbicara dan memberikan pengalaman obrolan grup yang lebih interaktif.

*Commands:* 
*Admins only:*
 • `/addchat`*:* Mengaktifkan mode Chatbot di obrolan.
 • `/rmchat`*:* Mode Bot Obrolan dinonaktifkan dalam obrolan.

Melaporkan bug di @{SUPPORT_CHAT}
*Didukung oleh CoffeeHouse* (https://coffeehouse.intellivoid.net/) from @Intellivoid
"""
