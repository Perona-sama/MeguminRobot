...
import MeguminRobot.modules.sql.global_bans_sql as gban_sql
import MeguminRobot.modules.sql.users_sql as user_sql
from MeguminRobot import DEV_USERS, OWNER_ID, dispatcher
